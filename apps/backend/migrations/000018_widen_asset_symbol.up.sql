...
-- Widen asset/symbol columns from VARCHAR(20) to VARCHAR(50)
ALTER TABLE tax_lots ALTER COLUMN asset TYPE VARCHAR(50);
ALTER TABLE assets ALTER COLUMN symbol TYPE VARCHAR(50);

-- Recreate tax_lots_effective view (from migration 000013)
...
-- Recreate position_wac materialized view (from migration 000016)
